...
dPdt  = (k1r*Ca + k2r*Ci - k1f*Ra*P - k2f*Ri*P)*(OBa+OBp) - kcl*P+ DPTH;
dRadt = k1r*Ca + k3f*Ri - k1f*Ra*P - k3r*Ra;
dRidt = k2r*Ci + k3r*Ra - k2f*Ri*P - k3f*Ri;
dCadt = k1f*Ra*P + k4f*Ci - k1r*Ca - k4r*Ca;
dCidt = k2f*Ri*P + k4r*Ca - k2r*Ci - k4f*Ci;


% now create column vector of state derivatives

xdot = [dPdt;dRadt;dRidt;dCadt;dCidt];